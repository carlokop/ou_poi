...
//		}
		...
		if (lat < -180 || lat > 180) {
			throw new IllegalArgumentException(
					"latitude out of range moet tussen de -180 en 180 zijn maar was: " + lat);
		}
		// test geldige waarde len
		if (len < -90 || len > 90) {
			throw new IllegalArgumentException(
					"longtitude out of range moet tussen de -90 en 90 zijn maar was: " + lat);
		}
	 ...
	 * 
	 * @contract happy
	 * @requires postcode voldoet aan het patroon 4 cijfer gevolgd door 2 letters
	 *           zonder spatie
	 * @ensures /result true
	 */
